...
public class frmlevel3 extends Activity implements B4AActivity{
	public static frmlevel3 mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "b4a.example", "b4a.example.frmlevel3");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (frmlevel3).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "b4a.example", "b4a.example.frmlevel3");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "b4a.example.frmlevel3", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (frmlevel3) Create " + (isFirst ? "(first time)" : "") + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (frmlevel3) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        if (!dontPause)
            BA.LogInfo("** Activity (frmlevel3) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
        else
            BA.LogInfo("** Activity (frmlevel3) Pause event (activity is not paused). **");
        if (mostCurrent != null)
...
public anywheresoftware.b4a.objects.ImageViewWrapper _imgbgnight = null;
public anywheresoftware.b4a.objects.ImageViewWrapper _imggrassnight = null;
...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 34;BA.debugLine="Activity.LoadLayout(\"FrmLevel3\")";
mostCurrent._activity.LoadLayout("FrmLevel3",mostCurrent.activityBA);
...
if (mostCurrent._functions._spanish /*boolean*/ ==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 36;BA.debugLine="LblScoreTxt.Text = \"PUNTAJE\"";
mostCurrent._lblscoretxt.setText(BA.ObjectToCharSequence("PUNTAJE"));
 //BA.debugLineNum = 37;BA.debugLine="LblShot.Text = \"TIRO\"";
mostCurrent._lblshot.setText(BA.ObjectToCharSequence("TIRO"));
 }else {
 //BA.debugLineNum = 39;BA.debugLine="LblScoreTxt.Text = \"SCORE\"";
mostCurrent._lblscoretxt.setText(BA.ObjectToCharSequence("SCORE"));
 //BA.debugLineNum = 40;BA.debugLine="LblShot.Text = \"SHOT\"";
...
if (mostCurrent._functions._spanish /*boolean*/ ==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 46;BA.debugLine="LblScoreTxt.Text = \"PUNTAJE\"";
mostCurrent._lblscoretxt.setText(BA.ObjectToCharSequence("PUNTAJE"));
 //BA.debugLineNum = 47;BA.debugLine="LblShot.Text = \"TIRO\"";
mostCurrent._lblshot.setText(BA.ObjectToCharSequence("TIRO"));
 }else {
 //BA.debugLineNum = 49;BA.debugLine="LblScoreTxt.Text = \"SCORE\"";
mostCurrent._lblscoretxt.setText(BA.ObjectToCharSequence("SCORE"));
 //BA.debugLineNum = 50;BA.debugLine="LblShot.Text = \"SHOT\"";
mostCurrent._lblshot.setText(BA.ObjectToCharSequence("SHOT"));
 };
...
public static String  _globals() throws Exception{
 ...
 //BA.debugLineNum = 16;BA.debugLine="Private ImgBgNight As ImageView";
mostCurrent._imgbgnight = new anywheresoftware.b4a.objects.ImageViewWrapper();
 //BA.debugLineNum = 17;BA.debugLine="Private ImgGrassNight As ImageView";
mostCurrent._imggrassnight = new anywheresoftware.b4a.objects.ImageViewWrapper();
...
public static String  _imgbot_click() throws Exception{
 //BA.debugLineNum = 58;BA.debugLine="Private Sub ImgBot_Click";
