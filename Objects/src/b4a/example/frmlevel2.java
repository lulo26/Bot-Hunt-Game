...
public class frmlevel2 extends Activity implements B4AActivity{
	public static frmlevel2 mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "b4a.example", "b4a.example.frmlevel2");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (frmlevel2).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "b4a.example", "b4a.example.frmlevel2");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "b4a.example.frmlevel2", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (frmlevel2) Create " + (isFirst ? "(first time)" : "") + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (frmlevel2) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        if (!dontPause)
            BA.LogInfo("** Activity (frmlevel2) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
        else
            BA.LogInfo("** Activity (frmlevel2) Pause event (activity is not paused). **");
        if (mostCurrent != null)
...
public anywheresoftware.b4a.objects.ImageViewWrapper _imgbgnoon = null;
public anywheresoftware.b4a.objects.ImageViewWrapper _imggrassnoon = null;
...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 35;BA.debugLine="Activity.LoadLayout(\"FrmLevel2\")";
mostCurrent._activity.LoadLayout("FrmLevel2",mostCurrent.activityBA);
 //BA.debugLineNum = 36;BA.debugLine="If Functions.Spanish = True Then";
if (mostCurrent._functions._spanish /*boolean*/ ==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 37;BA.debugLine="LblScoreTxt.Text = \"PUNTAJE\"";
mostCurrent._lblscoretxt.setText(BA.ObjectToCharSequence("PUNTAJE"));
 //BA.debugLineNum = 38;BA.debugLine="LblShot.Text = \"TIRO\"";
mostCurrent._lblshot.setText(BA.ObjectToCharSequence("TIRO"));
 }else {
 //BA.debugLineNum = 40;BA.debugLine="LblScoreTxt.Text = \"SCORE\"";
mostCurrent._lblscoretxt.setText(BA.ObjectToCharSequence("SCORE"));
 //BA.debugLineNum = 41;BA.debugLine="LblShot.Text = \"SHOT\"";
...
if (mostCurrent._functions._spanish /*boolean*/ ==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 47;BA.debugLine="LblScoreTxt.Text = \"PUNTAJE\"";
mostCurrent._lblscoretxt.setText(BA.ObjectToCharSequence("PUNTAJE"));
 //BA.debugLineNum = 48;BA.debugLine="LblShot.Text = \"TIRO\"";
mostCurrent._lblshot.setText(BA.ObjectToCharSequence("TIRO"));
 }else {
 //BA.debugLineNum = 50;BA.debugLine="LblScoreTxt.Text = \"SCORE\"";
mostCurrent._lblscoretxt.setText(BA.ObjectToCharSequence("SCORE"));
 //BA.debugLineNum = 51;BA.debugLine="LblShot.Text = \"SHOT\"";
mostCurrent._lblshot.setText(BA.ObjectToCharSequence("SHOT"));
 };
...
public static String  _globals() throws Exception{
 ...
 //BA.debugLineNum = 16;BA.debugLine="Private ImgBgNoon As ImageView";
mostCurrent._imgbgnoon = new anywheresoftware.b4a.objects.ImageViewWrapper();
 //BA.debugLineNum = 17;BA.debugLine="Private ImgGrassNoon As ImageView";
mostCurrent._imggrassnoon = new anywheresoftware.b4a.objects.ImageViewWrapper();
 //BA.debugLineNum = 18;BA.debugLine="Private ImgBot As ImageView";
mostCurrent._imgbot = new anywheresoftware.b4a.objects.ImageViewWrapper();
 //BA.debugLineNum = 19;BA.debugLine="Private LblHit As Label";
mostCurrent._lblhit = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 20;BA.debugLine="Private ImgHit1 As ImageView";
mostCurrent._imghit1 = new anywheresoftware.b4a.objects.ImageViewWrapper();
 //BA.debugLineNum = 21;BA.debugLine="Private ImgHit2 As ImageView";
mostCurrent._imghit2 = new anywheresoftware.b4a.objects.ImageViewWrapper();
 //BA.debugLineNum = 22;BA.debugLine="Private ImgHit3 As ImageView";
mostCurrent._imghit3 = new anywheresoftware.b4a.objects.ImageViewWrapper();
 //BA.debugLineNum = 23;BA.debugLine="Private ImgHit4 As ImageView";
mostCurrent._imghit4 = new anywheresoftware.b4a.objects.ImageViewWrapper();
 //BA.debugLineNum = 24;BA.debugLine="Private ImgHit5 As ImageView";
mostCurrent._imghit5 = new anywheresoftware.b4a.objects.ImageViewWrapper();
 //BA.debugLineNum = 25;BA.debugLine="Private ImgHit6 As ImageView";
mostCurrent._imghit6 = new anywheresoftware.b4a.objects.ImageViewWrapper();
 //BA.debugLineNum = 26;BA.debugLine="Private LblScoreTxt As Label";
...
mostCurrent._lblscore = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 28;BA.debugLine="Private LblShot As Label";
mostCurrent._lblshot = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 29;BA.debugLine="Private ImgShot1 As ImageView";
mostCurrent._imgshot1 = new anywheresoftware.b4a.objects.ImageViewWrapper();
 //BA.debugLineNum = 30;BA.debugLine="Private ImgShot2 As ImageView";
...
public static String  _imgbot_click() throws Exception{
 //BA.debugLineNum = 59;BA.debugLine="Private Sub ImgBot_Click";
