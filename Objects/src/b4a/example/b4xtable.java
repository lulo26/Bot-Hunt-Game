...
public class b4xtable extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "b4a.example.b4xtable");
            if (htSubs == null) {
...
public b4a.example.b4xtable._b4xtablecolumn  _addcolumn(String _title,int _columntype) throws Exception{
...
_c.Formatter /*b4a.example.b4xformatter*/  = _defaultdataformatter;
...
public String  _addcolumntoclv(b4a.example.b4xtable._b4xtablecolumn _c) throws Exception{
...
_sb.Append((" LIMIT "+__c.SmartStringFormatter("",(Object)(_mfirstrowindex))+", "+__c.SmartStringFormatter("",(Object)(_limit))+""));
 ...
 //BA.debugLineNum = 381;BA.debugLine="Dim aargs(args.Size) As String";
_aargs = new String[_args.getSize()];
java.util.Arrays.fill(_aargs,"");
 //BA.debugLineNum = 382;BA.debugLine="For i = 0 To args.Size - 1";
{
final int step43 = 1;
final int limit43 = (int) (_args.getSize()-1);
_i = (int) (0) ;
for (;_i <= limit43 ;_i = _i + step43 ) {
 //BA.debugLineNum = 383;BA.debugLine="aargs(i) = args.Get(i)";
...
public String  _cell_click() throws Exception{
 //BA.debugLineNum = 735;BA.debugLine="Private Sub Cell_Click";
 //BA.debugLineNum = 736;BA.debugLine="CellClicked(Sender, False)";
...
public String  _cell_longclick() throws Exception{
 //BA.debugLineNum = 739;BA.debugLine="Private Sub Cell_LongClick";
 //BA.debugLineNum = 740;BA.debugLine="CellClicked(Sender, True)";
...
public ResumableSub_CellClicked(b4a.example.b4xtable parent,anywheresoftware.b4a.objects.B4XViewWrapper _pnl,boolean _longclicked) {
this.parent = parent;
this._pnl = _pnl;
...
public String  _checkandremovecolumnthatwasaddedtoincorrectparent(b4a.example.b4xtable._b4xtablecolumn _c,boolean _isfrozen) throws Exception{
...
public ResumableSub_Clear(b4a.example.b4xtable parent) {
this.parent = parent;
}
b4a.example.b4xtable parent;
...
parent.__c.LogImpl("92359316","closing old db.",0);
...
public String  _columntosqltype(b4a.example.b4xtable._b4xtablecolumn _c) throws Exception{
...
public String  _createcolumnlayouts(b4a.example.b4xtable._b4xtablecolumn _c,int _size) throws Exception{
int _i = 0;
anywheresoftware.b4a.objects.B4XViewWrapper _p = null;
...
public ResumableSub_DesignerCreateView(b4a.example.b4xtable parent,Object _base,anywheresoftware.b4a.objects.LabelWrapper _lbl,anywheresoftware.b4a.objects.collections.Map _props) {
this.parent = parent;
this._base = _base;
this._lbl = _lbl;
this._props = _props;
...
public b4a.example.b4xtable._b4xtablecolumn  _getcolumn(String _columnid) throws Exception{
b4a.example.b4xtable._b4xtablecolumn _c = null;
...
public anywheresoftware.b4a.objects.B4XViewWrapper  _getlabelfromcolumn(b4a.example.b4xtable._b4xtablecolumn _c,int _index) throws Exception{
anywheresoftware.b4a.objects.B4XViewWrapper _p = null;
...
public String  _headerclicked(b4a.example.b4xtable._b4xtablecolumn _col) throws Exception{
b4a.example.b4xtable._b4xtablecolumn _c = null;
...
public ResumableSub_ImplUpdateDataFromQuery(b4a.example.b4xtable parent,String _query,Object _args,int _totalcount,boolean _dontsleep) {
this.parent = parent;
this._query = _query;
this._args = _args;
...
_c.Formatter /*b4a.example.b4xformatter*/ ._formatlabel /*String*/ (_rs.GetDouble(_c.SQLID /*String*/ ),_lbl);
 if (true) break;
...
//C
this.state = 71;
 //BA.debugLineNum = 456;BA.debugLine="GetLabelFromColumn(c, i).Text = \"\"";
...
parent.__c.LogImpl("93342406",BA.ObjectToString(parent.__c.LastException(ba)),0);
 if (true) break;
;
...
anywheresoftware.b4a.objects.B4XViewWrapper _lbl = null;
 //BA.debugLineNum = 725;BA.debugLine="Private Sub lbl_Click";
 //BA.debugLineNum = 726;BA.debugLine="Dim lbl As B4XView = Sender";
_lbl = new anywheresoftware.b4a.objects.B4XViewWrapper();
_lbl = (anywheresoftware.b4a.objects.B4XViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.B4XViewWrapper(), (java.lang.Object)(__c.Sender(ba)));
 //BA.debugLineNum = 727;BA.debugLine="CellClicked(lbl.Parent, False)";
...
anywheresoftware.b4a.objects.B4XViewWrapper _lbl = null;
 //BA.debugLineNum = 730;BA.debugLine="Private Sub lbl_LongClick";
 //BA.debugLineNum = 731;BA.debugLine="Dim lbl As B4XView = Sender";
_lbl = new anywheresoftware.b4a.objects.B4XViewWrapper();
_lbl = (anywheresoftware.b4a.objects.B4XViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.B4XViewWrapper(), (java.lang.Object)(__c.Sender(ba)));
 //BA.debugLineNum = 732;BA.debugLine="CellClicked(lbl.Parent, True)";
...
_c = (b4a.example.b4xtable._b4xtablecolumn)(_visiblecolumns.Get(_i));
 //BA.debugLineNum = 242;BA.debugLine="Dim offset As Float = 0";
_offset = (float) (0);
...
public String  _removecolumnfromclv(b4a.example.b4xtable._b4xtablecolumn _c) throws Exception{
int _i = 0;
...
if ((_c).equals((b4a.example.b4xtable._b4xtablecolumn)(_clvdata._getvalue(_clvindex))) == false) { 
...
public String  _resizecolumnimpl(b4a.example.b4xtable._b4xtablecolumn _c,int _totalheight) throws Exception{
float _height = 0f;
int _topint = 0;
int _heightint = 0;
int _i = 0;
...
public ResumableSub_SearchField_TextChanged(b4a.example.b4xtable parent,String _old,String _new) {
this.parent = parent;
this._old = _old;
this._new = _new;
}
...
public ResumableSub_SetData(b4a.example.b4xtable parent,anywheresoftware.b4a.objects.collections.List _data) {
this.parent = parent;
this._data = _data;
}
b4a.example.b4xtable parent;
...
this.state = 7;
;
 //BA.debugLineNum = 659;BA.debugLine="sql1.Initialize(\"\", \":memory:\", True)";
...
if (true) return "";
 ...
 //BA.debugLineNum = 511;BA.debugLine="Dim cs As CSBuilder";
_cs = new anywheresoftware.b4a.objects.CSBuilder();
 //BA.debugLineNum = 512;BA.debugLine="cs.Initialize.Append(Text.SubString2(0, x)).Col";
_cs.Initialize().Append(BA.ObjectToCharSequence(_text.substring((int) (0),_x))).Color(_highlighttextcolor).Append(BA.ObjectToCharSequence(_text.substring(_x,(int) (_x+_filtertext.length())))).Pop();
 //BA.debugLineNum = 513;BA.debugLine="cs.Append(Text.SubString(x + FilterText.Length)";
_cs.Append(BA.ObjectToCharSequence(_text.substring((int) (_x+_filtertext.length()))));
 //BA.debugLineNum = 515;BA.debugLine="lbl.Text = cs";
...
public String  _updatesearchfieldvisibility() throws Exception{
 //BA.debugLineNum = 273;BA.debugLine="Private Sub UpdateSearchFieldVisibility";
